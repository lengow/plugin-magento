 ...
 */
class Lengow_Marketplace_Adminhtml_Lengow_ProductController extends Mage_Adminhtml_Controller_Action {
    ...
    {
        $this->getResponse()->setBody($this->getLayout()->createBlock('lengow/adminhtml_product_grid')->toHtml());
        return $this;
    }
