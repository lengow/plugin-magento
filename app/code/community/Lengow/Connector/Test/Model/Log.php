...
class Lengow_Connector_Test_Model_Log extends EcomDev_PHPUnit_Test_Case
{
    ...
    {
        $model = Mage::helper('lengow_connector');
        $model->log('Category', 'Test Message 1');
        $model->log('Category', 'Test Message 2');
        $model->log('Category', 'Test Message 3');
    ...
    {
        $model = Mage::helper('lengow_connector');
        $model->log('Category', 'Test Message 4');
        $model->log('Category', 'Test Message 5');
        $model->log('Category', 'Test Message 6');
